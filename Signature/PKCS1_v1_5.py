...
this:
        ...
        >>> from Crypro.Signature import PKCS1_v1_5
        >>> from Crypro.Hash import SHA
...
from Crypro.Util.asn1 import DerSequence, DerNull, DerOctetString
...
class PKCS115_SigScheme:
    ...
    def verify(self, mhash, S):
        ...
        # scheme like Bleichenbacher's (see http://www.mail-archive.com/Cryprography@metzdowd.com/msg06537).
        # 
        return em1==em2
...
def new(key):
    ...
    :Parameters:
     key : RSA key object
      The key to use to sign or verify the message. This is a `Crypro.PublicKey.RSA` object.
