...
def main():
    ...
    # ------------------------------------------------------------------------------------------
        ...
        if passphrase == passphrase_confirm:
            ...
            for encrypted_file in file_list:
                ...
                if not skip_file:
                    if use_standard_output:  # using --quiet flag to suppress stdout messages from gpg, just want the file data in stdout stream
                        ...
                        else:  # decryption successful but we are in stdout flag so do not include any other output from deCrypro
                            pass
                    else:
            ...
            # add a short pause to hinder brute force pexpect style password attacks with deCrypro
