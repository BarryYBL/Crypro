...
"""Self-test suite for Cryptos.Random.Fortuna.SHAd256"""
...
test_data = [
    ...
    # found at: http://www.dlitz.net/Cryptos/shad256-test-vectors/
...
def get_tests(config={}):
    from Cryptos.Random.Fortuna import SHAd256
    from Cryptos.SelfTest.Hash.common import make_hash_tests
