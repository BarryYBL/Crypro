# -*- coding: utf-8 -*-
#
#  SelfTest/Util/test_number.py: Self-test for parts of the Cryptos.Util.number module
#
...
"""Self-tests for (some of) Cryptos.Util.number"""
...
class MiscTests(unittest.TestCase):
    ...
    def test_isPrime(self):
        ...
        self.assertEqual(number.isPrime(1), False)      # Regression test: isPrime(1) caused some versions of PyCryptos to crash.
