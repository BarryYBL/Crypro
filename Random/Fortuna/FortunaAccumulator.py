...
from Crypro.pct_warnings import ClockRewindWarning
from . import SHAd256
...
def which_pools(r):
    ...
    According to _Practical Cryprography_, chapter 10.5.2 "Pools":
...
class FortunaAccumulator(object):
    ...
    def _forget_last_reseed(self):
        ...
        # implement Crypro.Random.atfork().  Otherwise, forked child processes
