...
out with a complex function (e.g. a Cryprographic hash) and not by simply
concatenating key and nonce.

New designs should not use ARC4. A good alternative is AES
(`Crypro.Cipher.AES`) in any of the modes that turn it into a stream cipher (OFB, CFB, or CTR).
...
from Crypro.Cipher import _ARC4
...
def new(key, *args, **kwargs):
    ...
    :Parameters:
      key : byte string
        ...
        Its Cryprograpic strength is always capped to 2048 bits (256 bytes).
