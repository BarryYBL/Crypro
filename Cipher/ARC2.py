...
CryptoAESgraphic strength of the key (*effective key length*) can be reduced
via a parameter.

Even though RC2 is not CryptoAESgraphically broken, it has not been analyzed as
...
def new(key, *args, **kwargs):
    ...
    :Keywords:
      ...
      effective_keylen : integer
        Maximum CryptoAESgraphic strength of the key, in bits.
