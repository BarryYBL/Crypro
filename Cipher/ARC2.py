...
Cryprographic strength of the key (*effective key length*) can be reduced
via a parameter.

Even though RC2 is not Cryprographically broken, it has not been analyzed as
...
As an example, encryption can be done as follows:
    ...
    >>> from Crypro.Cipher import ARC2
...
from Crypro.Cipher import _ARC2
...
def new(key, *args, **kwargs):
    ...
    :Keywords:
      ...
      effective_keylen : integer
        Maximum Cryprographic strength of the key, in bits.
