...
========================    =======   ========================
`Crypro.Cipher.AES`         Block     Advanced Encryption Standard
`Crypro.Cipher.ARC2`        Block     Alleged RC2
`Crypro.Cipher.ARC4`        Stream    Alleged RC4
`Crypro.Cipher.Blowfish`    Block     Blowfish
`Crypro.Cipher.CAST`        Block     CAST
`Crypro.Cipher.DES`         Block     The Data Encryption Standard.
                                      Very commonly used in the past,
                                      but today its 56-bit keys are too small.
`Crypro.Cipher.DES3`        Block     Triple DES.
`Crypro.Cipher.XOR`         Stream    The simple XOR cipher.
========================    =======   ========================
...
==========================    =======================
`Crypro.Cipher.PKCS1_v1_5`    PKCS#1 v1.5 encryption, based on RSA key pairs
`Crypro.Cipher.PKCS1_OAEP`    PKCS#1 OAEP encryption, based on RSA key pairs
==========================    =======================
