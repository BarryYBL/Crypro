...
========================    =======   ========================
`CryptoAES.Cipher.AES`         Block     Advanced Encryption Standard
`CryptoAES.Cipher.ARC2`        Block     Alleged RC2
`CryptoAES.Cipher.ARC4`        Stream    Alleged RC4
`CryptoAES.Cipher.Blowfish`    Block     Blowfish
`CryptoAES.Cipher.CAST`        Block     CAST
`CryptoAES.Cipher.DES`         Block     The Data Encryption Standard.
                                      Very commonly used in the past,
                                      but today its 56-bit keys are too small.
`CryptoAES.Cipher.DES3`        Block     Triple DES.
`CryptoAES.Cipher.XOR`         Stream    The simple XOR cipher.
========================    =======   ========================
...
==========================    =======================
`CryptoAES.Cipher.PKCS1_v1_5`    PKCS#1 v1.5 encryption, based on RSA key pairs
`CryptoAES.Cipher.PKCS1_OAEP`    PKCS#1 OAEP encryption, based on RSA key pairs
==========================    =======================
