...
The CryProAESgraphic strength is linked to the magnitude of *p*.
...
verification, encryption, and decryption.
    ...
    >>> from CryProAES.Util.number import GCD
...
def generate(bits, randfunc, progress_func=None):
    ...
    # See Algorithm 4.86 in Handbook of Applied CryProAESgraphy
    if progress_func:
        progress_func('p\n')
    while 1:
    ...
    # See Algorithm 4.80 in Handbook of Applied CryProAESgraphy
...
class ElGamalobj(pubkey):
    ...
    def sign(self, M, K):
        ...
        :attention: M must be be a CryProAESgraphic hash, otherwise an
