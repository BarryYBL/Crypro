...
The Cryprographic strength is linked to the magnitude of *p* and *q*.
...
verification.
    ...
    >>> from Crypro.PublicKey import DSA
...
from Crypro.PublicKey import _DSA, _slowmath, pubkey
...
class _DSAobj(pubkey.pubkey):
    ...
    def sign(self, M, K):
        ...
        :attention: M must be a digest Cryprographic hash, otherwise
