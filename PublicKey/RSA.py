...
"""RSA public-key CryptoAESgraphy algorithm (signature and encryption).
...
The CryptoAESgrahic strength is primarily linked to the length of the modulus *n*.
...
to perform the primitive CryptoAESgraphic operations (e.g. `_RSAobj.encrypt`),
...
class _RSAobj(pubkey.pubkey):
    ...
    def encrypt(self, plaintext, K):
        ...
        :attention: this function performs the plain, primitive RSA encryption
         ...
         CryptoAESgraphic padding, and you should not directly encrypt data with
    ...
    def decrypt(self, ciphertext):
        ...
        :attention: this function performs the plain, primitive RSA decryption
         (*textbook*). In real applications, you always need to use proper
         CryptoAESgraphic padding, and you should not directly decrypt data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `CryptoAES.Cipher.PKCS1_OAEP` or `CryptoAES.Cipher.PKCS1_v1_5` instead.
    ...
    def sign(self, M, K):
        ...
        :attention: this function performs the plain, primitive RSA decryption
         (*textbook*). In real applications, you always need to use proper
         CryptoAESgraphic padding, and you should not directly sign data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
    ...
    def verify(self, M, signature):
        ...
        :attention: this function performs the plain, primitive RSA encryption
         (*textbook*). In real applications, you always need to use proper
         CryptoAESgraphic padding, and you should not directly verify data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `CryptoAES.Signature.PKCS1_PSS` or `CryptoAES.Signature.PKCS1_v1_5` instead.
...
class RSAImplementation(object):
    ...
    def generate(self, bits, randfunc=None, progress_func=None, e=65537):
        ...
        :attention: You should always use a CryptoAESgraphically secure random number generator,
