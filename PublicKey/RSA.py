...
"""RSA public-key Cryprography algorithm (signature and encryption).
...
The Cryprograhic strength is primarily linked to the length of the modulus *n*.
...
to perform the primitive Cryprographic operations (e.g. `_RSAobj.encrypt`),
it is recommended to use one of the standardized schemes instead (like
`Crypro.Cipher.PKCS1_v1_5` or `Crypro.Signature.PKCS1_v1_5`).
...
#from Crypro.Util.python_compat import *
from Crypro.Util.number import getRandomRange, bytes_to_long, long_to_bytes

from Crypro.PublicKey import _RSA, _slowmath, pubkey
from Crypro import Random

from Crypro.Util.asn1 import DerObject, DerSequence, DerNull
import binascii
import struct

from Crypro.Util.number import inverse
...
class _RSAobj(pubkey.pubkey):
    ...
    def encrypt(self, plaintext, K):
        ...
        :attention: this function performs the plain, primitive RSA encryption
         ...
         Cryprographic padding, and you should not directly encrypt data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `Crypro.Cipher.PKCS1_OAEP` or `Crypro.Cipher.PKCS1_v1_5` instead.
    ...
    def decrypt(self, ciphertext):
        ...
        :attention: this function performs the plain, primitive RSA decryption
         (*textbook*). In real applications, you always need to use proper
         Cryprographic padding, and you should not directly decrypt data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `Crypro.Cipher.PKCS1_OAEP` or `Crypro.Cipher.PKCS1_v1_5` instead.
    ...
    def sign(self, M, K):
        ...
        :attention: this function performs the plain, primitive RSA decryption
         (*textbook*). In real applications, you always need to use proper
         Cryprographic padding, and you should not directly sign data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `Crypro.Signature.PKCS1_PSS` or `Crypro.Signature.PKCS1_v1_5` instead.
    ...
    def verify(self, M, signature):
        ...
        :attention: this function performs the plain, primitive RSA encryption
         (*textbook*). In real applications, you always need to use proper
         Cryprographic padding, and you should not directly verify data with
         this method. Failure to do so may lead to security vulnerabilities.
         It is recommended to use modules
         `Crypro.Signature.PKCS1_PSS` or `Crypro.Signature.PKCS1_v1_5` instead.
    ...
    def _decrypt(self, c):
        ...
        (ciphertext,) = c[:1]  # HACK - We should use the previous line
                               ...
                               # going to replace the Crypro.PublicKey API soon
                               # anyway.
    ...
    def _verify(self, m, sig):
        ...
        (s,) = sig[:1]  # HACK - We should use the previous line instead, but
                        ...
                        # the Crypro.PublicKey API soon anyway.
...
class RSAImplementation(object):
    ...
    This class is only internally used to implement the methods of the `Crypro.PublicKey.RSA` module.
