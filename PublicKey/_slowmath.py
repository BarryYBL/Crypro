...
"""Pure Python implementation of the RSA-related portions of Cryptos.PublicKey._fastmath."""
...
from Cryptos.Util.number import size, inverse, GCD
...
def rsa_construct(n, e, d=None, p=None, q=None, u=None):
    ...
    if p is not None and q is not None:
        ...
        # See 8.2.2(i) in Handbook of Applied Cryptosgraphy.
        ktot = d*e-1
