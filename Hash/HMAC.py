...
# into PyCrypro (the "Modifications").
#
...
from Crypro.Util.strxor import strxor_c
...
class HMAC:
    ...
    def __init__(self, key, msg = None, digestmod = None):
        ...
        :Parameter digestmod:
            ...
            Default is `Crypro.Hash.MD5`.
        :Type digestmod:
            A hash module or object instantiated from `Crypro.Hash`
        """
...
def new(key, msg = None, digestmod = None):
    ...
    :Parameters:
      ...
      msg : byte string
        ...
        Optional.
    :Parameter digestmod:
        The hash to use to implement the HMAC. Default is `Crypro.Hash.MD5`.
    :Type digestmod:
        A hash module or instantiated object from `Crypro.Hash`
    :Returns: An `HMAC` object
    """
